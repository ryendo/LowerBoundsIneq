...
%   It delegates to my_intlab_config, whose interprocess lock serializes
%   the proof-critical INTLAB data-MAT load/save across all clients and
%   workers. It also defensively scrubs other Intlab installations that may
%   appear on the shared system path.
